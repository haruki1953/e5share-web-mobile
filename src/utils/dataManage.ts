...
export const loadAllData = async () => {
  ...
  const helping_by_users = profileStore.user?.helping_by_users
  const account_status = profileStore.user?.account_status
  if (helping_by_users) {
...
export const loadE5PostsData = async (e5id: number) => {
